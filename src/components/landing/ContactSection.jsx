            ...
            <ScrollReveal delay={0.1}>
              ...
              >
                ...
                <button
                  type="submit"
                  disabled={sending}
                  className="w-full mt-8 px-8 py-4 rounded-xl bg-navy text-white font-semibold text-base hover:bg-navy/90 transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-60"
                >
                  {sending ? (
                    <>
